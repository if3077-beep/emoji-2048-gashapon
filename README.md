...
![游戏](https://img.shields.io/badge/version-v0.6.0-ff6b4a?style=for-the-badge)
![size](https://img.shields.io/badge/gzip-113KB-22c55e?style=for-the-badge)
...
| 🐾 **宠物进化** | 🥚 蛋 → 幼崽 → 成体 → 觉醒（4 形态 + 7 套装扮） |
| 📜 **12 章主线** | 通关 1 区解锁 1 新区，终章 20,000 币 |
| 💰 **慷慨奖励** | 觉醒 +500~10,000 币 + 暴击 + 季节 + 幸运区 + 周末 |
...
## 📊 三个版本对比（v0.4 / v0.5 / v0.6）

| | v0.4 留存 | v0.5 深度 | v0.6 社交 |
|---|---|---|---|
...
| 周末双倍 | — | — | ✅ |
| 主题展示墙 | — | — | ✅ |
| gzip | 104.97 KB | 109.78 KB | **113.02 KB** |

详见 [VERSION_COMPARISON_V456.md](./VERSION_COMPARISON_V456.md) · [CHANGELOG.md](./CHANGELOG.md)
